...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      {/* ================= HERO BANNER ================= */}
      <section className="relative flex min-h-[380px] items-center overflow-hidden sm:min-h-[420px] md:min-h-[480px] lg:min-h-[560px]">
        <Image
        ...
        />
        {/* Dark overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#020b13]/60 via-[#061827]/40 to-[#061827]/20" />
